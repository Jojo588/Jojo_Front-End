...
const Projects = () => {
  ...
  return (
    <div className="h-fit ml-14 mr-14 bg-gray-100 dark:bg-[#1A1A2E] text-black dark:text-white mb-20 max-md:mt-10 max-sm:mx-2 transition-all duration-500">
      <h1 className="text-center text-4xl font-bold text-[#FCA311] mb-8">Projects</h1>

      <ul className="flex justify-between items-center gap-10 text-lg capitalize text-gray-600 dark:text-gray-400">
        <li
          className={`w-1/3 text-center cursor-pointer py-2 relative transition duration-300 hover:text-[#FCA311] 
            ...
            ${
              changeProject === 1
                ? "text-[#FCA311] after:scale-x-100 font-semibold"
                : ""
            }`}
      ...
      <div className="relative">
        ...
        >
          <ReactWithTailwind ReactwithtailwindList={ReactwithtailwindList} />
        </div>
        <div
          className={`transition-opacity duration-300 ${
            changeProject === 2
        ...
        >
          <ReactWithCss3 Reactwithcsslist={Reactwithcsslist} />
        </div>
        <div
          className={`transition-opacity duration-300 ${
            changeProject === 3
        ...
        >
          <JsWithCss3 jswithcsslist={jswithcsslist} />
        </div>
      </div>
    </div>
  );
