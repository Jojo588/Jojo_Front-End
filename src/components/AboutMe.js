...
const AboutMe = () => {
  return (
    <section className="transition-all duration-500 min-h-fit mt-15 mb-32 w-full items-center bg-gray-100 dark:bg-[#1A1A2E] px-6 py-16 md:px-24 max-sm:mb-5 max-md:py-10 max-lg:mb-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex gap-4 flex-col md:flex-row items-center md:items-start max-md:gap-8">
          ...
          {/* About Text */}
          <div className="md:w-2/3 text-black dark:text-gray-300 text-xl leading-relaxed space-y-6 text-left md:text-justify max-sm:text-lg max-sm:tracking-tight">
            <p>
